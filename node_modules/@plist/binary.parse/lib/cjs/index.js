...
const parse = (buffer) => {
    // check header
    const headerBytes = buffer.slice(0, common_1.HEADER_BINARY.length);
    if (DECODER_UTF8.decode(headerBytes) !== common_1.HEADER_BINARY) {
        throw new Error(`Invalid binary plist. Expected '${common_1.HEADER_BINARY}' at offset 0.`);
    }
    ...
    function parseObject(tableOffset) {
        ...
        function parseDate() {
            ...
            return new Date(common_1.EPOCH + 1000 * readDouble(dateBuffer));
        }
        function parseData() {
            let dataoffset = 1;
            let length = objInfo;
